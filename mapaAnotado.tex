...
\shade[left color=color2,right color=color1] (0.3,0.97) rectangle (0.7,0.99);
\node[align=right,text width=3cm, color=gray] at (0.2,0.98) {Valor más pequeño};
\node[align=left,text width=3cm, color=gray] at (0.8,0.98) {Valor más grande};
%\node[align=right] at (0.5,0.5) {\begin{tcolorbox}[width=4in,
%	enhanced,
%	frame hidden,
%	interior hidden,
%	boxsep=0pt,
...
%	right=0pt,
%	top=2pt,
%	interior style={left color=color2,right color=color1}
%	]%%
%	
%	\end{tcolorbox}};
