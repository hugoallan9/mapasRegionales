...
\begin{document}
\begin{tikzpicture}
\node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics{mapaRegional}};
...
%\node[text width=3cm, color=gray] at (0.83,0.99) {Guatemala \\ \guatemala \%};

\draw [ gray] (0.46,0.2) -- (0.46,0.03);
\filldraw [gray] (0.46,0.2) circle (1.2pt);
\draw [ gray] (0.46,0.03) -- (0.73,0.03);
\node[text width=3cm, color=gray] at (0.835,0.03) {Guatemala  \guatemala };


% ###############ALTA VERAPAZ############################## %
\draw [ gray] (0.5,0.4) -- (0.5,0.9);
\filldraw [gray] (0.5,0.4) circle (1.2pt);
\draw [ gray] (0.4989,0.9) -- (0.88,0.9);
\node[text width=3cm, color=gray] at (0.985,0.9) {AltaVerapaz \\ \altaVerapaz \%};
...
\node[text width=3cm, color=gray] at (0.835,0.83) {Baja Verapaz \\ \bajaVerapaz \%};

%#############EL PROGRESO################################# %
\draw [ gray] (0.55,0.28) -- (0.55,0.76);
\filldraw [gray] (0.55,0.28) circle (1.2pt);
\draw [ gray] (0.55,0.76) -- (0.88,0.76);
\node[text width=3cm, color=gray] at (0.985,0.76) {El Progreso \\  \elProgreso \%};
...
\node[text width=3cm, color=gray] at (0.835,0.69) {Petén \\  \peten \%};

%#############IZABAL################################# %
\draw [ gray] (0.64,0.45) -- (0.64,0.62);
\filldraw [gray] (0.64,0.45) circle (1.2pt);
\draw [ gray] (0.6389,0.62) -- (0.88,0.62);
\node[text width=3cm, color=gray] at (0.985,0.62) {Izabal \\  \izabal \%};
...
\draw [ gray] (0.59,0.39) -- (0.88,0.39);
\node[text width=3cm, color=gray] at (0.985,0.39) {Zacapa \\ \zacapa \%};
...
\node[text width=3cm, color=gray] at (0.835,0.32) {Chiquimula \\  \zacapa \%};

%#############JALAPA################################# %
\filldraw [gray] (0.55,0.20) circle (1.2pt);
\draw [ gray] (0.65,0.20) -- (0.65,0.25);
\draw [ gray] (0.65,0.25) -- (0.88,0.25);
\draw [ gray] (0.55,0.20) -- (0.65,0.20);
\node[text width=3cm, color=gray] at (0.985,0.25) {Jalapa \\  \jalapa \%};
...
\node[text width=3cm, color=gray] at (0.835,0.18) {Jutiapa \\  \jutiapa \%};

%#############SANTA ROSA################################# %
\filldraw [gray] (0.48,0.11) circle (1.2pt);
\draw [ gray] (0.48,0.11) -- (0.88,0.11);
%\draw [ gray] (0.48,0.11) -- (0.48,0.11);
\node[text width=3cm, color=gray] at (0.985,0.11) {Santa Rosa \\  \santaRosa \%};
...
%\node[align=right, text width=3cm, color=gray] at (0.10,0.99) {Sacatepéquez \\ \sacatepequez \%};

\draw [ gray] (0.42,0.2) -- (0.42,0.03);
\filldraw [gray] (0.42,0.2) circle (1.2pt);
\draw [ gray] (0.42,0.03) -- (0.00,0.03);
\node[align=right, text width=3cm, color=gray] at (-0.10,0.03) {Sacatepéquez \\ \sacatepequez \%};

% ###############QUICHE############################## %
\draw [ gray] (0.39,0.4) -- (0.39,0.9);
\filldraw [gray] (0.39,0.4) circle (1.2pt);
\draw [ gray] (0.39,0.9) -- (0.00,0.9);
\node[align=right, text width=3cm, color=gray] at (-0.10,0.9) {Quiché \\ \quiche \%};
...
\node[align=right,text width=3cm, color=gray] at (0.05,0.83) {Sololá \\ \solola \%};

% ###############TOTONICAPAN############################## %
\draw [ gray] (0.31,0.29) -- (0.31,0.76);
\filldraw [gray] (0.31,0.29) circle (1.2pt);
\draw [ gray] (0.31,0.76) -- (0.00,0.76	);
\node[align=right,text width=3cm, color=gray] at (-0.10,0.76) {Totonicapán \\ \totonicapan \%};

% ###############QUETZALTENANGO############################## %
\draw [ gray] (0.28,0.26) -- (0.28,0.69);
\filldraw [gray] (0.28,0.26) circle (1.2pt);
\draw [ gray] (0.28,0.69) -- (0.15,0.69	);
\node[align=right,text width=3cm, color=gray] at (0.05,0.69) {Quetzaltenango \\ \quetzaltenango \%};
...
\node[align=right,text width=3cm, color=gray] at (-0.10,0.62) {San Marcos \\ \sanMarcos \%};
...
\node[align=right,text width=3cm, color=gray] at (0.05,0.55) {Huehuetenango \\ \huehuetenango \%};
...
\node[align=right,text width=3cm, color=gray] at (-0.10,0.17) {Escuintla \\ \escuintla \%};
...
\node[align=right,text width=3cm, color=gray] at (0.05,0.10) {Chimaltenango \\ \chimaltenango \%};
...
\node[align=right,text width=3cm, color=gray] at (0.05,0.24) {Suchitepéquez \\ \suchitepequez \%};

% ###############RETALHULEU############################## %
\draw [ gray] (0.26,0.19) -- (0.26,0.31);
\filldraw [gray] (0.26,0.19) circle (1.2pt);
\draw [ gray] (0.26,0.31) -- (0.00,0.31	);
\node[align=right,text width=3cm, color=gray] at (-0.10,0.31) {Retalhuleu \\  \retalhuleu \%};
